...
/**
 * Created by furstmartins on 23/12/15.
 */
public class Numerals {
    ...
    public String toString(BigDecimal value) {
		...
		*/
        ...
        //processes decimal
        if (decimal.signum()>0){
            s+=s==null || s.trim().equals("") ? "" : " "+CONJUNCTION.AND.name+" ";
        ...
        try{
            ...
            for (int i=1; i<orders.size(); i++){
                ...
                if (value!=0){
					 ...
					 * (EVITA "UM MIL")
					 */
// comentado para realmente trazer 'Um Mil' necessário no preenchimento dos cheques
//                    if (i==1 && value==1){
//                        s=q+s;
//                    }else{
